...
NIE MOGE
	podmienić referencji: z.v1 = new Value(...); (błąd kompilacji)
	
		Zmiany dotyczą tylko tej jednej instancji Zad7_18.

v2 – static final (klasowe)
MOGE
	zmienić zawartość wspólnego obiektu: Zad7_18.v2.i = 149 (lepiej przez nazwę klasy, ale fa.v2.i = ... też zadziała)

NIE MOGE
	podmienić referencji: Zad7_18.v2 = new Value(...); (błąd kompilacji)
...
też podmienić referencję: z.v3 = new Value(rand.nextInt(...));
